...
public class FilterDispatcher implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (uri.equalsIgnoreCase(req.getContextPath() + ProtectedAppURIS.APP_USER_MASTER)
                ...
                || uri.equalsIgnoreCase(req.getContextPath() + ProtectedAppURIS.APP_USER_MASTER_EVENT_HOME)
                || uri.equalsIgnoreCase(req.getContextPath() + ProtectedAppURIS.APP_USER_MASTER_CREATE_EVENT)
                || uri.equalsIgnoreCase(req.getContextPath() + ProtectedAppURIS.APP_USER_MASTER_SHOW_EVENTS)
                || uri.equalsIgnoreCase(req.getContextPath() + ProtectedAppURIS.APP_USER_MASTER_SUCCESS_STORY_HOME)
                || uri.equalsIgnoreCase(req.getContextPath() + ProtectedAppURIS.APP_USER_MASTER_CREATE_SUCCESS_STORY)
                || uri.equalsIgnoreCase(req.getContextPath() + ProtectedAppURIS.APP_USER_MASTER_SHOW_SUCCESS_STORY)
