                ...
                <div class="container_12">
                    <div class="grid_12">
                        <div class="wrap pad-3">
                            ...
                            <div class="block-6">
                                <h3 class="p6"> <strong>Map Faculty to Subject</strong></h3>
                                    ...
                                    <fieldset>
                                        ...
                                        <label><sf:select path="facultyName" id="facultyName">
                                                ...
                                                <c:forEach items="${faculties}" var="faculty">
                                                    <sf:option value="${faculty.facultyName}">${faculty.facultyName}</sf:option>
                                                </c:forEach>
                                            </sf:select>

                                        </label>

                                        <div class="btns"><a href="#" class="button" id="createMap">Map</a></div>
                                    </fieldset>
                                </sf:form>
