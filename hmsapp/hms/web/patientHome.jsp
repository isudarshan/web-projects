        ...
        AppUser appUser = (AppUser) request.getSession().getAttribute("user");
            ...
            <form id="form_571622" class="appnitro"  method="post" action="LoginController">
                <div class="form_description">
                    ...
                    <div id="pic">
                        <img src="${pageContext.request.contextPath}/ImageController2?firstName=<%=appUser.getUserName()%>" width="100" height="100"/>
                        <br/>
        ...
        if (request.getAttribute("success") != null) {
                ...
                <table align="center" cellpadding="10" cellspacing="5" border="2">
                    <tr>
                        ...
                        <td><a href="PatientController?action=viewMyPrescription&patientName=<%=appUser.getUserName()%>">View Prescriptions</a></td>
                    </tr>

                    <tr>

                        <td><a href="PatientController?action=viewMyReports&id=<%=request.getSession().getAttribute("id") == null ? request.getSession().getAttribute("id") : ""%>">View Reports</a></td>
                        <td><a href="setQuestion.jsp">Set SecurityQusetion</a></td>
                    </tr>
