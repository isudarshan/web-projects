  ...
  <div class="border">
    <div id="header">
      ...
      <div class="socials right">
        <ul>
          <li><a href="login.jsp" class="rss">Login</a></li>
      ...
      <ul>
        <li>
          <div class="item">
            ...
            <img src="css/images/slider01..jpg" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            
            <img src="css/images/slider02.png" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            
            <img src="css/images/slider03.png" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/slider04.jpeg" alt="" /> </div>
        </li>
      </ul>
    </div>
    <div id="main">
